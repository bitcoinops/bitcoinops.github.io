...
- **Discussion about Bitcoin Core's priorities:** several blog posts
  ...
  makes it easy for users to connect their wallets to their own personal
  nodes, although this is done using blockchain indexes (basically [a
  ...
  operate the full nodes that validate the predominate amount economic
