...
{% include functions/details-list.md
  ...
  we request its parents from? What are some reasons things this may
  ...
  a3="An attacker can announce a malleated orphan (see Q2) unsolicited.
  ...
  a4="Instead of adding the missing parent transaction to the
  ...
  attacks such as described in Q3."
...
- [How long does Bitcoin Core store forked chains?]({{bse}}124973)
  ...
  in pruned mode, blocks that a node downloads, regardless of if they are in the
...
- [LDK #3446][] adds support for including a [trampoline payment][topic
  ...
  provide full support for using trampoline routing or providing trampoline
...
- [BIPs #1535][] merges [BIP348][] for the specification of the
  ...
  covenants] proposals, which is often proposed in combination with restoring
  [OP_CAT][topic op_cat].

- [BOLTs #1180][] updates [BOLT12][topic offers] to specify the optional
  inclusion of [BIP353][] human-readable bitcoin payment instructions (see
  Newsletter [#290][news290 omdns]) in the invoice request, and [BLIPs #48][]
