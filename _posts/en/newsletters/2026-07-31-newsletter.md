...
- **Move funds secured by COLDCARD-generated keys:** if you used a
  ...
  models may also be affected.  See the News section below for details. {% assign timestamp="1:07" %}
...
- **Wallets generated by COLDCARD at risk of theft**:
  ...
  A [security advisory][coinkite advisory] by Coinkite identified wallets
  ...
  In a follow-up [technical backgrounder][coinkite backgrounder], Coinkite
  ...
  element is also mixed in, although an [analysis][block analysis] by Block,
  ...
  [Coinkite's blog][coinkite blog] and other sources for updates. Bitcoin Optech
  ...
  alone does not make an existing seed safe. {% assign timestamp="2:18" %}
...
- **Disclosure of two DoS vulnerabilities in Core Lightning**: Chandra Pratap
  ...
  mechanism for the internal map. {% assign timestamp="36:26" %}
...
- **Proof of concept for a zero-knowledge proof of reserves**: fabohax [posted][zkpoh del]
  ...
  currently available in a dedicated [repository][zkpoh gh]. {% assign timestamp="49:54" %}
...
- [What is Bitcoin's objective definition of transaction neutrality?]({{bse}}130849)
  ...
  spendable scripts unspendable or breaking a deployed protocol. {% assign timestamp="1:03:07" %}
...
- [Why does BIP110's decentralization benefit not outweigh its impact on transaction neutrality?]({{bse}}130848)
  ...
  outlawed patterns would simply be replaced by other transactions. {% assign timestamp="1:05:17" %}
...
- [Why does BIP110 require a 55% signaling threshold if its nodes reject non-signaling blocks?]({{bse}}130885)
  ...
  nodes discard non-signaling blocks. {% assign timestamp="1:09:46" %}
...
- [Why use ElligatorSwift encoding in BIP324?]({{bse}}130887)
  ...
  to mimic other protocols. {% assign timestamp="1:17:12" %}
...
- [Was the OP_SUCCESSx reservation in BIP342 designed with specific opcode families in mind?]({{bse}}130670)
  ...
  could never perform. {% assign timestamp="1:25:36" %}
...
- [What is the difference between the long-term feerate and the discard feerate?]({{bse}}130861)
  ...
  consolidatory and thrifty [coin selection][topic coin selection]. {% assign timestamp="1:29:14" %}
...
- [What is the quickest method for migrating a legacy wallet to a descriptor wallet on a pruned node?]({{bse}}130713)
  ...
  node with the relevant blocks. {% assign timestamp="1:32:40" %}
...
- [Is there historical data on orphan/stale block rates during high-fee periods?]({{bse}}130889)
  ...
  provides the [raw data][stale blocks repo] for deriving custom metrics. {% assign timestamp="1:36:09" %}
...
- [BTCPay Server 2.4.1][] is a maintenance release for this self-hosted payment
  ...
  improvements and bug fixes. {% assign timestamp="1:41:25" %}
...
- [Eclair 0.14.1][] is a maintenance release for this LN node implementation.
  ...
  should review the [release notes][eclair 0.14.1 notes]. {% assign timestamp="1:42:14" %}
...
- [Bitcoin Core #34628][] replaces independent per-peer transaction relay
  ...
  count rates. {% assign timestamp="1:44:26" %}
...
- [Bitcoin Core #28463][] increases the default maximum number of connections
  ...
  eclipse attacks]. {% assign timestamp="1:49:49" %}
...
- [Bitcoin Core #32800][] adds explicit [BIP141][] and policy-adjusted
  ...
  adds the explicit `vsize_bip141` field. {% assign timestamp="1:54:18" %}
...
- [Bitcoin Core #34683][] adds an automatically generated [OpenRPC 1.4.1][]
  ...
  details. {% assign timestamp="1:56:54" %}
...
- [Bitcoin Core #33014][] fixes how `descriptorprocesspsbt` (see [Newsletter
  ...
  in the `hex` field. {% assign timestamp="1:58:09" %}
...
- [Eclair #3325][] accepts [BOLT12][topic offers] invoice [onion messages][topic
  ...
  replypath]). {% assign timestamp="1:59:31" %}
...
- [BOLTs #1346][] specifies [BOLT12][topic offers] payer proofs, a receipt format
  ...
  proof]). {% assign timestamp="2:00:57" %}
...
- [BOLTs #1344][] extends the [attributable failures][topic attributable
  ...
  standardizing any application. {% assign timestamp="2:02:10" %}
...
- [BOLTs #1343][] adds the `option_onion_messages_only_channels` feature bit for
  ...
  peers. {% assign timestamp="2:04:14" %}
