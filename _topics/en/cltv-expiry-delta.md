...
optech_mentions:
  ...
  - title: "New attack against LN payment atomicity: raising HTLC expiry delta recommended"
  ...
  - title: "Eclair #2677 raises its `max_cltv` to 2,016 blocks due widespread increases in HTLC expiry deltas"
  ...
  - title: "Longer HTLC expiry deltas as a mitigation against replacement cycling attacks"
...
excerpt: >
  **CLTV expiry delta** is the number of blocks a node has to settle a
  stalled payment before it could potentially lose money.
