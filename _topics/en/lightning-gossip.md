...
optech_mentions:
  ...
  - title: V2 gossip update proposal
  ...
  - title: Updated v2 gossip proposal
    url: /en/newsletters/2022/02/23/#updated-ln-gossip-proposal

  - title: Continued discussion about updated v2 gossip protocol
  ...
  - title: LN developer meeting discussion about v2 gossip improvements
  ...
  - title: LDK #2198 increases the amount before gossiping that a channel is down
  ...
  - title: Updated channel announcements discussed during LN developer meeting
  ...
  - title: Anonymous usage tokens proposed with potential application for LN gossip
...
excerpt: >
  **Lightning gossip** is the decentralized protocol used announce the
  existence and settings of LN nodes and channels.
...
[BOLT7][] gossip protocol "gossip v1".  One key feature of gossip v1
...
allowing signatures for a broad range of UTXOs to used---not just UTXOs
that match an LN template.  This would allowing breaking the connection
...
with gossip v1.5 being proposed as a less ambitious alternative.
